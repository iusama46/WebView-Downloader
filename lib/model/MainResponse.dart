...
class Appconfiguration {
  ...
  Appconfiguration(
      ...
      this.floatingButton,
      this.isPullRefresh,
      this.tabStyle,this.isCookieEnable});
...
class About {
  ...
  About({this.whatsAppNumber, this.instagramUrl, this.twitterUrl, this.facebookUrl, this.callNumber, this.snapchat, this.skype, this.messenger, this.youtube, this.isShowAbout});
